...
// TODO: this information is coupled into the vertex structure; the renderer module needs to be redesigned to enforce a pipeline structure instead of defining a language for pipeline structure
void Assets::Material::Initialize(Core::DependencyInjection::ServiceProvider* services, void* asset)
{
	...
	if (!services->GetRenderer()->CreateMaterial(material->VertShader.Data->RendererID, material->FragShader.Data->RendererID, s_VertexLayoutHardCode, s_VertexLayoutLength, material->RendererID))
	{
