...
Core::Runtime::CallbackResult LoadLegacyMaterial(Core::Pipeline::IAssetEnumerator *inputStreams,
                        Core::Runtime::ServiceTable *services,
                        void *moduleState);
                        
Core::Runtime::CallbackResult UnloadLegacyMaterial(Core::Pipeline::HashId *ids, size_t count,
