...
// Engine::Core::Runtime::CallbackResult
// Engine::Extension::OrcaRendererModule::Assets::ContextualizeShader(
...
//         {
//             state->GetLogger()->Information("Shader {} is already loaded.",
//             outContext[i].AssetId); outContext[i].Buffer.Type =
//             Engine::Core::AssetManagement::LoadBufferType::Invalid;
//         }
//         else
//         {
...
//     unsigned char* assetFile = (unsigned
//     char*)services->TransientAllocator->GetBuffer(inContext->Buffer.Location.TransientBufferId);
...
//     SDL_GPUShader* shader = SDL_CreateGPUShader(services->GraphicsLayer->GetDevice(),
//     &createInfo); if (shader == nullptr)
//     {
//         state->GetLogger()->Error("Failed to create shader {}, detail: {}", inContext->AssetId,
//         SDL_GetError()); return Engine::Core::Runtime::CallbackSuccess();
//     }
