...
void EngineHost::AddSinkModule(void *(*create)(DependencyInjection::ServiceProvider *services),
                               void (*update)(void *moduleInstance, DependencyInjection::ServiceProvider *services),
                               void (*finalize)(void *moduleInstance, DependencyInjection::ServiceProvider *services),
