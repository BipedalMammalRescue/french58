...
template <> struct fmt::formatter<Engine::Core::Pipeline::Variant> : fmt::formatter<std::string>
{
    auto format(Engine::Core::Pipeline::Variant my, format_context &ctx) const
        -> decltype(ctx.out())
    {
        switch (my.Type)
        {
        ...
        case Engine::Core::Pipeline::VariantType::Vec3:
            return fmt::format_to(ctx.out(), "({}, {}, {})", my.Data.Vec3.x, my.Data.Vec3.y,
                                  my.Data.Vec3.z);
        case Engine::Core::Pipeline::VariantType::Vec4:
            return fmt::format_to(ctx.out(), "({}, {}, {}, {})", my.Data.Vec4.x, my.Data.Vec4.y,
                                  my.Data.Vec4.z, my.Data.Vec4.w);
        ...
        case Engine::Core::Pipeline::VariantType::Mat3:
            return fmt::format_to(ctx.out(), "({}, {}, {})", my.Data.Mat3[0], my.Data.Mat3[1],
                                  my.Data.Mat3[2]);
        case Engine::Core::Pipeline::VariantType::Mat4:
            return fmt::format_to(ctx.out(), "({}, {}, {}, {})", my.Data.Mat4[0], my.Data.Mat4[1],
                                  my.Data.Mat4[2], my.Data.Mat4[3]);
