...
HomogeneousStorage::Segment *HomogeneousStorage::CreateNewSegment(unsigned int count)
{
...
void *HomogeneousStorage::Take()
{
    ...
    if (m_headSegment == nullptr)
    {
        ...
        m_headSegment = CreateNewSegment(m_initialCount);
    ...
    {
        Segment *newSegment = CreateNewSegment(m_tailSegment->Count * 2);
